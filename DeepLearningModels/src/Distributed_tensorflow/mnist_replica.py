# -*- coding: utf-8 -*-
#python3 mnist_replica.py --job_name="ps" --task_index=0
#python3 mnist_replica.py --job_name="worker" --task_index=0
#python3 mnist_replica.py --job_name="worker" --task_index=1
#! /usr/bin/env python
...
flags.DEFINE_boolean(
    ...
    "server.")
# 参数服务器主机
flags.DEFINE_string("ps_hosts","192.168.70.121:2222",
                    "Comma-separated list of hostname:port pairs")
# 工作节点主机
flags.DEFINE_string("worker_hosts", "192.168.70.122:2223,192.168.70.123:2224",
                    "Comma-separated list of hostname:port pairs")
# 本作业是工作节点还是参数服务器
