...
parser.add_argument('--config_path', help='Path to Darknet cfg file.', default='./model_data/yolov2.cfg')
parser.add_argument('--weights_path', help='Path to Darknet weights file.', default='./model_data/yolo.weights')
