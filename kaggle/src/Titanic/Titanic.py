...
def feature_Engineering(combined_train_test):
    ...
    combined_train_test.drop(['PassengerId', 'Embarked', 'Sex', 'Name', 'Title', 'Fare_bin_id', 'Pclass_Fare_Category', 
                          'Parch', 'SibSp', 'Family_Size_Category', 'Ticket', 'Name_length', 'Ticket_Letter', 'Age', 'Fare'], axis=1,inplace=True)
    '''
    combined_train_test.drop(['PassengerId', 'Name', 'Parch', 'SibSp',  'Ticket',  'Ticket_Letter', 'Family_Size_Category', 'Fare_bin_id'], axis=1,inplace=True)
...
if __name__ == '__main__':
    ...
    model.fit(titanic_train_data_X, titanic_train_data_Y, batch_size=32, epochs=100)
